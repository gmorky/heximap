...
% Show message
warndlg(['Make sure this region you selected has sufficient image' ...
    ' contrast, minimal cloud cover, some vertical relief in the terrain,' ...
    ' a good disparity map, and does not contain a significant amount' ...
    ' of unstable terrain.'],'Warning');

% Create "use this region" push button
iW = 0.2; iH = 0.05; iL = (0.5-iW/2)-iW; iB = 0.03;
